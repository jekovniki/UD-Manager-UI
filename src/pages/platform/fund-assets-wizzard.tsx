...
import { AssetWizzardStep } from "@/features/funds/components/asset-wizzard-step";
		...
		<main className="min-h-screen">
			<header className="min-h-[100px] bg-white border-b flex items-center justify-between px-4">
				...
				<AssetWizzardStep
					...
					name="Дялове на К.И.С"
					isActive={currentStep === 3}
					isCompleted={currentStep > 3}
				/>
				<AssetWizzardStep
					step={4}
					description="СТЪПКА 4"
					name="Други активи"
			...
			<div className="grid fund-wizzard-content-height w-full grid-cols-[1fr_auto]">
				<section id="assets">Left</section>
