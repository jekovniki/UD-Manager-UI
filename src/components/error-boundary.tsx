...
export const DefaultErrorBoundary = (props: FallbackProps) => {
    ...
    return (
        <div className="w-3/5 m-auto">
            <div className="">
                <svg id="500_Bill" xmlns="http://www.w3.org/2000/svg" viewBox="-8.5 9.5 560 250">
                    <defs>
                    ...
                    <g id="light-glow" clip-path="url(#circle-mask)">
                        ...
                        <path id="glow-outer-2" className="glow" opacity=".25" fill="#FF8D8D" d="M378.7 198.2c-48.8 0-88.5-39.7-88.5-88.5s39.7-88.5 88.5-88.5 88.5 39.7 88.5 88.5-39.7 88.5-88.5 88.5z" />
                    ...
                    <g id="Bill">
                        ...
                        <g id="Ears">
                            <g id="Ear-right">
                                ...
                                <path id="Ear-fill-highlight" className="bill-highlight" fill="#F00" fill-opacity="0.7" d="M281.8 142.2c-5.5 0-9.9-4.4-9.9-9.9s4.4-9.9 9.9-9.9 9.9 4.4 9.9 9.9-4.5 9.9-9.9 9.9z" />
                                ...
                                <path id="Ear-outline-highlight" className="bill-highlight" fill="#F00" fill-opacity="0.7" d="M281.8 123.3c4.9 0 8.9 4 8.9 8.9s-4 8.9-8.9 8.9-8.9-4-8.9-8.9 3.9-8.9 8.9-8.9m0-2c-6 0-10.9 4.9-10.9 10.9s4.9 10.9 10.9 10.9 10.9-4.9 10.9-10.9-4.9-10.9-10.9-10.9z" />
                            </g>
                            <g id="Ear-left">
                        ...
                        <g id="Face">
                            ...
                            <path id="Face-Outline-highlight" className="bill-highlight" fill="#F00" d="M242 72.5c-2.5 0-8.3.8-12.4 1.9l4.9.8c2.4-.5 4.9-.7 7.4-.7 22 0 40 17.9 40 39.9v28.7c0 22-18 39.9-40 39.9-2.6 0-5.2-.3-7.6-.7v2c2.5.5 5 .7 7.6.7 23.2 0 42-18.8 42-41.9v-28.7c.1-23.1-18.7-41.9-41.9-41.9z" />
                            ...
                            <path id="Face-highlight" className="bill-highlight" fill="#F00" fill-opacity=".15" d="M241.5 74.5c-2.2 0-4.2.2-6.3.5 19 3.1 33.7 19.5 33.7 39.4v28.7c0 19.8-15 36.3-33.9 39.4 2.1.3 4.5.5 6.7.5 22 0 40.2-17.9 40.2-39.9v-28.7c0-22-18.4-39.9-40.4-39.9z" />
                        </g>
                        ...
                        <g id="facial-hair">
                            ...
                            <path opacity=".3" fill="#F00" d="M284.2 121.7H283l-1.3 19.6c0 6.6-3.1 12.7-10.2 12.7H268v.4c0 20.3-14.6 37.1-35 41.1 3 .6 6.2.9 9.5.9 25.1 0 44.5-18.7 44.5-42 0-5.4-2.2-25.7-2.8-32.7z" id="beard-highlight" className="bill-highlight" fill-opacity="0.7" />
                        </g>
                        ...
                        <path id="body-highlight" className="bill-highlight" fill="none" stroke="#F00" stroke-width="2" stroke-linejoin="round" stroke-miterlimit="10" stroke-opacity=".3" d="M257.2 194.2l-.2 5.8h13c6.4 0 14 6.9 14 6.9" />
                    </g>
                    ...
                    <g id="smokes" fill="#D5DADB">
                        <use className="emitted-ember" />
                        <use className="emitted-ember emitted-ember-alt" style={{ animationDelay: "-0.5s"}} />
                        <use className="emitted-ember" style={{ animationDelay: ' -0.7s'}} />
                        <use className="emitted-ember emitted-ember-alt" style={{ animationDelay: '-1s' }} />
                        <circle id="smoke-base-1" className="smoke" style={{ animationDelay: '-0.2s', transformOrigin: '464.3px 78.4px'}} cx="464.3" cy="78.4" r="11.3" />
                        <circle id="smoke-base-3" className="smoke" style={{ animationDelay: '-0.1s', transformOrigin: '492.9px 83.8px'}} cx="492.9" cy="83.8" r="8.6" />
                        <circle id="smoke-base-2" style={{ transformOrigin: '4280px 70.4px'}} className="smoke" cx="480" cy="70.4" r="8" />
                        <circle id="smoke-float-2" style={{ transformOrigin: '464.9px 53.3px'}} className="emitted-ember" fill-opacity=".8" cx="464.9" cy="53.3" r="5.4" />
                        <circle id="smoke-float-1" style={{ transformOrigin: '469.4px 62.3px'}} className="emitted-ember emitted-ember-alt" fill-opacity=".8" cx="469.4" cy="62.3" r="7.6" />
                        <circle id="smoke-float-3" style={{ transformOrigin: '471.1px 47.9px'}} className="emitted-ember" fill-opacity=".8" cx="471.1" cy="47.9" r="4.5" />
                        <circle id="smoke-float-5" style={{ transformOrigin: '470.4px 28.2'}} className="emitted-ember" fill-opacity=".3" cx="470.4" cy="28.2" r="2.5" />
                        <circle id="smoke-float-4" style={{ transformOrigin: '467.2px 36.3px'}} className="emitted-ember emitted-ember-alt" fill-opacity=".6" cx="467.2" cy="36.3" r="3.2" />
                    </g>
                    <g id="fire" clip-path="url(#flame-mask)">
                        <path id="flame-back" style={{ transformOrigin: '470.729px 93px'}} className="flame-front" fill="#D14D40" d="M456.3 93l14-24.8L485.1 93z" />
                        <path id="flame-front-left" style={{ transformOrigin: '462.55px 93px'}} className="flame-front" fill="#FB6A4F" d="M458.7 79l-5.2 14h18.1z" />
                        <path id="flame-front-right" style={{ transformOrigin: '479.162px 93px'}} className="flame-front anim-delay-1" fill="#FB6A4F" d="M497 93l-9.2-35.5L461.3 93z" />
                        <path id="flame-inner-left" style={{ transformOrigin: '461.677px 97px'}} className="flame-inner" fill="#FFD657" d="M456.7 97l5.8-12.4 4.1 12.4z" />
                        <path id="flame-inner-right" style={{ transformOrigin: '476.268px 97px'}} className="flame-inner" fill="#FFD657" d="M492.1 97L484 77.3 460.4 97z" />
                    </g>
            ...
            <div className="mt-2 text-2xl mb-8">Причина за грешката:<br /> {error.message}</div>
            <div className="text-center">
                <Button variant="secondary" className="mt-4" onClick={resetErrorBoundary}>Презареди страницата</Button>
            </div>
        </div>
